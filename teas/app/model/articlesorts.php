...
/**
 * Articlesorts 封装来自 article_sorts 数据表的记录及领域逻辑
 */
class Articlesorts extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                ...
                'parent_id' => array
                (
                    array('is_int', '父类的id必须是一个整数'),

                ),

                'news_count' => array
                (
                    array('is_int', '新闻数目必须是一个整数'),
