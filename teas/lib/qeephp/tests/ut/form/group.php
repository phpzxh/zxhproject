<?php
// $Id: group.php 2242 2009-02-16 21:26:30Z dualface $
...
class UT_Form_Group extends QTest_UnitTest_Abstract
{
     ...
     */
    function testNestedValidate($test_failed, $post, $values)
    {
     ...
     * @dataProvider nestedDataProvider
     */
    function testNestedValidate2($test_failed, $post, $values)
    {
        $form = Form_Group::createFromConfig();
     ...
     * @dataProvider nestedDataProvider
     */
    function testNestedValidate3($test_failed, $post, $values)
    {
        $form = Form_Group::createFromConfig();
     ...
     * @dataProvider nestedDataProvider
     */
    function testDataBinding($test_failed, $post, $values)
    {
        $form = Form_Group::createFromConfig();
     ...
     * @dataProvider nestedDataProvider
     */
    function testDataBinding2($test_failed, $post, $values)
    {
        $form = Form_Group::createFromConfig();
