...
<p>如果您无法确定这些内容是否正确，请联系您的主机供应商。如果您还需要其他帮助，请访问 <a href='http://wordpress.org/support/'>WordPress Support Forums</a>，中文用户请访问 <a href='http://wfans.org/forums/'> WordPress 爱好者社区</a>。</p>
...
<p>如果您不知道如何安装一个数据库，那您应该<strong>联系服务器供应商</strong>。如果问题还是无法解决，请登录 <a href="http://wordpress.org/support/">WordPress Support Forums</a> 获取社区帮助，中文用户请中文用户请访问 <a href="http://wfans.org/forums/"> WordPress 爱好者社区</a>。</p>'/*/WP_I18N_DB_SELECT_DB*/, $db, DB_USER));
			return;
		}
	}
	...
	function print_error($str = '') {
		...
		print "<div id='error'>
		<p class='wpdberror'><strong>WordPress 数据库错误：</strong> [$str]<br />
		<code>$query</code></p>
		</div>";
	}
