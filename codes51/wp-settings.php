...
if ( version_compare( '4.3', phpversion(), '>' ) ) {
	die( sprintf( /*WP_I18N_OLD_PHP*/'您服务器PHP版本是 %s，但 WordPress 需要至少 4.3 以上。'/*/WP_I18N_OLD_PHP*/, phpversion() ) );
}
...
if ( !extension_loaded('mysql') && !file_exists(WP_CONTENT_DIR . '/db.php') )
	die( /*WP_I18N_OLD_MYSQL*/'您的 PHP 缺少 WordPress 必需的 MySQL 组件。'/*/WP_I18N_OLD_MYSQL*/ );
...
if ( is_wp_error($prefix) )
	wp_die(/*WP_I18N_BAD_PREFIX*/'<strong>错误</strong>：<code>wp-config.php</code> 里设置的数据库表前缀 <code>$table_prefix</code> 只能使用数字、字母或下划线。'/*/WP_I18N_BAD_PREFIX*/);
