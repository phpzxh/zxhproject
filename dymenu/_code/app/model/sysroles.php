...
/**
 * Sysroles 封装来自 sysroles 数据表的记录及领域逻辑
 */
class Sysroles extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'group_id' => array
                (
                    array('is_int', 'group_id必须是一个整数'),

                ),

                'rolename' => array
                (
                    array('max_length', 64, 'rolename不能超过 64 个字符'),
                ...
                'req' => array
                (
                    array('max_length', 255, 'req不能超过 255 个字符'),
