...
/**
 * Rolesgroup 封装来自 sysroles_group 数据表的记录及领域逻辑
 */
class Rolesgroup extends QDB_ActiveRecord_Abstract
{
        ...
        (
            ...
            (
                ...
                # 'other' => array('has_one' => 'Class'),
				 'roles' =>array(QDB::HAS_MANY =>'Sysroles', 'target_key'=>'group_id'),
            ),
            ...
            (
                'title' => array
                (
                    array('max_length', 128, 'title不能超过 128 个字符'),
