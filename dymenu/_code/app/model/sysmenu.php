...
/**
 * Sysmenu 封装来自 sysmenu 数据表的记录及领域逻辑
 */
class Sysmenu extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'title' => array
                (
                    array('max_length', 32, 'title不能超过 32 个字符'),

                ),

                'controller' => array
                (
                    array('max_length', 32, 'controller不能超过 32 个字符'),

                ),

                'action' => array
                (
                    array('max_length', 32, 'action不能超过 32 个字符'),

                ),

                'args' => array
                (
                    array('max_length', 255, 'args不能超过 255 个字符'),

                ),

                'icon' => array
                (
                    array('max_length', 255, 'icon不能超过 255 个字符'),

                ),

                'description' => array
                (
                    array('max_length', 255, 'description不能超过 255 个字符'),

                ),

                'target' => array
                (
                    array('max_length', 32, 'target不能超过 32 个字符'),
